package 강의_241002_04_자동차만들기종합_팀원의코드수정1;
...
public class SportsCar extends Vehicle {
    ...
    void drive() {
        ...
        double count = Math.ceil((double)(sel_passenger_num / 2) * distance / (mileage * fuelTank));


        double totalFuelCost = fuelConsumption * count;
        ...
        System.out.println("총 이동 시간 : " + intAdjustedValue + "시간 " + adjusted_min + "분");
    }
}
